...
/**
 * CardGrid.jsx
 * - Renders 10 copies of your original cyber card.
 * - CSS unchanged; only added dynamic content (name/title/subtitle) per card.
 */
...
const CardGrid = () => {
  const cards = [
    ...
    },
    {
      ...
      title: "SKIEZ DIGITAL",
      subtitle: "UI/UX",
      gradient: "linear-gradient(744deg, #ff7eb3, #ff758c 60%, #ff65a3)",
    },
    {
      name: "RAHUL VERMA",
      title: "SKIEZ DIGITAL",
      subtitle: "BACKEND",
      gradient: "linear-gradient(744deg, #43e97b, #38f9d7 60%, #00c9ff)",
    },
    {
      name: "PRIYA SHARMA",
      title: "SKIEZ DIGITAL",
      subtitle: "DEVOPS",
      gradient: "linear-gradient(744deg, #ff9966, #ff5e62 60%, #ff7e5f)",
    },
    {
      name: "ARAVIND RAJ",
      title: "SKIEZ DIGITAL",
      subtitle: "AI ENGINEER",
      gradient: "linear-gradient(744deg, #667eea, #764ba2 60%, #8e2de2)",
    },
    {
      name: "NISHA KUMARI",
      title: "SKIEZ DIGITAL",
      subtitle: "FULL STACK",
      gradient: "linear-gradient(744deg, #f7971e, #ffd200 60%, #ffb347)",
    },
    {
      name: "ROHAN IYER",
      title: "SKIEZ DIGITAL",
      subtitle: "BLOCKCHAIN",
      gradient: "linear-gradient(744deg, #30cfd0, #330867 60%, #1a2980)",
    },
    {
      name: "AAMIR KHAN",
      title: "SKIEZ DIGITAL",
      subtitle: "AI RESEARCH",
      gradient: "linear-gradient(744deg, #fc466b, #3f5efb 60%, #00c3ff)",
    },
    {
      name: "LAVANYA DAS",
      title: "SKIEZ DIGITAL",
      subtitle: "FRONTEND",
      gradient: "linear-gradient(744deg, #00f2fe, #4facfe 60%, #00c6ff)",
    },
    {
      name: "VIKRAM PATEL",
      title: "SKIEZ DIGITAL",
      subtitle: "BACKEND",
      gradient: "linear-gradient(744deg, #f953c6, #b91d73 60%, #8e2de2)",
    },
  ];
...
/* We'll create the same structure you had for each card,
   but make the .canvas generate 25 trackers (tr-1 ... tr-25)
   so all hover grid areas used by CSS exist. */
const Card = ({ gradient, name, title, subtitle }) => {
  // create 25 trackers to match CSS selectors tr-1..tr-25
        ...
        <div className="canvas">
          ...
          <div id="card">
            <div className="card-content">
              ...
              {/* <-- dynamic content inserted here, CSS remains the same --> */}
              <p id="prompt">{name}</p>
              <div className="title">
                {/* keep the same line-break style as original */}
...
const StyledWrapper = styled.div`
  --card-gradient: ${({ gradient }) =>
    gradient || "linear-gradient(45deg,#1a1a1a,#262626)"};
  ...
  /* Hover effects (these rely on trackers) */
  ...
  /* per-tracker transforms that create tilt directions */
  .tr-1:hover ~ #card {
